...
export PATH="${PATH}:/opt/Liclipse"
export PATH="${PATH}:/opt/pycharm-community-2023.2.3/bin"


#################################################################################
# Some basic vairalbes

export EDITOR='nvim'
export PAGER='bat --language=man --sytle=full --theme=OneDarkLight'
export SUDO_PROMPT="${red}${normal}==>"
...
export KDOTDIR="$HOME/.config/kitty"
##################################################################################
# XDG variables
...
####################################################################################
# Environment variables for the note function

export MY_NOTES="$HOME/.notes" # The file to keep the notes in
export NOTE_NUM_DIR="$HOME/.note_num" # the file to keep track of the note number
...
# export DOCKER_HOST="ssh://root@104.248.108.121"

export CLOUDFLARE_TOKEN="eyJhIjoiYWI2ZjRhOWRkOWYxYmIwMjA3MTEwOGYyM2M1YWNiYjkiLCJ0IjoiNGU2MWI1ZmUtYWFhMy00MDg2LTg4MjktNThiMGRjMjExMmM2IiwicyI6Ik1EUTNPV1ZtTkRJdFlqZzBaUzAwTlRnM0xXRTBabVF0Wm1FNVltTTFNek0yWm1ZNCJ9"
# vim:ft=zsh:nowrap
